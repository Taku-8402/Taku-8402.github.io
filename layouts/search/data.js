var data = [
    ...
    { url:"../../omiyage/omiyage4.html", title:"じゃじゃ麺", body:"盛岡じゃじゃ麺は冷麺、わんこそばと並んで盛岡三大麺として知られています。うどんやきしめんのような独特の平たい麺に、特製の肉味噌とキュウリ、ネギなどをかけたもので、麺を食べ終わった後は、卵と肉味噌、茹で汁をそそいでかき混ぜた「鶏蛋湯」として食べることもできます。" },
    { url:"../../omiyage/omiyage5.html", title:"岩谷堂羊羹", body:"岩谷堂羊羹：定番の逸品をはじめ、くるみ、ごま、季味までいろいろな羊羹があります。甘さにもコクがあったり、さっぱりとしていたりと様々です。お好みの羊羹をお楽しみください。" },
    { url:"../../omiyage/omiyage6.html", title:"小岩井農場チーズケーキ", body:"小岩井農場伝統の製法で作り上げた、こだわりのチーズケーキです。シンプルでありながら深い味わいをお楽しみください。「ベイクドチーズケーキSAHO」と「レアチーズケーキ」の2種類があります。" },
    { url:"../../omiyage/omiyage7.html", title:"前沢牛カレー", body:"ブランド牛である前沢牛のお肉をたっぷり使ったカレーです。ほろほろとしたお肉、そしてその旨味が詰まったカレーは普段とは一味違った特別感のある味わいとなっています。" },
    { url:"../../omiyage/omiyage8.html", title:"三陸海宝漬", body:"三陸海宝漬：三陸産のアワビ・いくら・めかぶを醤油ベースの出汁に漬け込んだ贅沢な商品です。柔らかく煮たアワビに、プチプチのいくら、粘りの強いめかぶといった三陸の恵みを一度に味わうことができます。" },
    { url:"../../omiyage/omiyage9.html", title:"南部せんべい", body:"南部せんべいの小麦と胡麻の味わいは、昔おばあちゃんが囲炉裏端で焼いていたせんべいの温もりを伝えてくれます。" },
